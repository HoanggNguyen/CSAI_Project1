...
def draw_info(screen, step_count, start_time, ares_weight, ares_cost):
    WIDTH, HEIGHT = screen.get_size()
    font = pygame.font.Font(None, 26)
    step_text = font.render(f'Steps: {step_count}', True, pygame.Color('white'))
    weight_text = font.render(f'Weight: {ares_weight}', True, pygame.Color('white'))
    cost_text = font.render(f'Cost: {ares_cost}', True, pygame.Color('white'))
    ...
    screen.blit(cost_text, (10, HEIGHT - 70))
    screen.blit(time_text, (10, HEIGHT - 90))
...
def draw_buttons(screen, paused, run_all_pressed):
    ...
    button_info = [
        ...
        {"color": "green", "label": "Run All", "y": run_all_y, "enabled": not run_all_pressed},
        {"color": "pink", "label": "Restart", "y": restart_y},
        {"color": "yellow", "label": "Next Step", "y": next_step_y},
        {"color": "red", "label": "Continue" if paused else "Pause", "y": pause_y}
    ]
    ...
    for button in button_info:
        ...
        color = pygame.Color(button["color"]) if button.get("enabled", True) else pygame.Color("gray")
        pygame.draw.rect(screen, color, (BUTTON_X, button["y"], BUTTON_WIDTH, BUTTON_HEIGHT))
