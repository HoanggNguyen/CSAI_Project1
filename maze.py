...
def read_input_file(file_path):
    with open(file_path, 'r') as f:
        ...
        maze_data = [line.rstrip() for line in f if line.strip()]
...
class SearchSpace:
    ...
    def update_maze_step(self, step, screen):
        ...
        if next_node:
            if step.isupper() and next_node.content == 'Stone':  # Check if pushing a stone
...
def algorithm_selection_screen(screen):
    ...
    while running:
        ...
        for button in buttons:
            ...
            pygame.draw.rect(screen, pygame.Color('dodgerblue'), 
    ...
    return selected_algo  # Return the selected algorithm
